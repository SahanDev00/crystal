...
const ForgotPassword = () => {
  ...
  const handleReset = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://kmatadmin.worldpos.biz/api/Customer/GetByEmail?EmailAddress=${email}`,{
        method: 'GET',
        headers: {
          'APIKey': apiKey,
        },
      ...
      if (data.success) {
        ...
        const tokenResponse = await fetch('https://kmatadmin.worldpos.biz/Api/Token', {
          method: 'POST',
          headers: {
        ...
        console.log(tokenData.data.tokenID)
