...
const Features = () => {
  return (
    <div className='w-full bg-cyan-200 relative font-overpass'>
        <div className='w-[90%] space-y-5 py-10 mx-auto flex flex-wrap items-center justify-center cursor-default'>
            <div className='w-[400px] 2lg:w-[300px] 3lg:w-[400px] h-full flex items-center gap-4 justify-center group'>
