      ...
      { isMenu && (
          <div className='w-full h-[200px] duration-300 border-b border-black/60 shadow'>
              <ul className='flex flex-col gap-2 justify-center items-center w-full h-full'>
                ...
                <Link to='/store' className={` font-overpass text-lg hover:text-cyan-500 duration-300 cursor-pointer ${isActive('/checkout') ? 'text-white' : ''} ${isActive('/cart') || isActive('/account') || isActive('/contact-us') || isActive('/my-orders') || isActive('/order-details') || isActive('/edit-profile') || isActive('/login') ? 'text-white' : ''}  ${isActive('/store') || isActive('/product') ? 'text-cyan-500' : ''} ${isActive('/') || isActive('/about-us') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'text-white' : ''}`}>Store</Link>
                <Link to='/about-us' className={` font-overpass text-lg hover:text-cyan-500 duration-300 cursor-pointer ${isActive('/checkout') ? 'text-white' : ''} ${isActive('/cart') || isActive('/product') || isActive('/account') || isActive('/contact-us') || isActive('/my-orders') || isActive('/store') || isActive('/edit-profile') || isActive('/order-details') || isActive('/login') ? 'text-white' : ''} ${isActive('/about-us') ? 'text-cyan-500' : ''}  ${isActive('/') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'text-white' : ''}`}>About Us</Link>
                <Link to='/contact-us' className={` font-overpass text-lg hover:text-cyan-500 duration-300 cursor-pointer ${isActive('/checkout') || isActive('/about-us') ? 'text-white' : ''} ${isActive('/cart') || isActive('/product') || isActive('/account') || isActive('/store') || isActive('/my-orders') || isActive('/edit-profile') || isActive('/order-details') || isActive('/login') ? 'text-white' : ''}  ${isActive('/contact-us') ? 'text-cyan-500' : ''}  ${isActive('/') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'text-white' : ''}`}>Contact Us</Link>
              </ul>
          </div>
        )
      }
