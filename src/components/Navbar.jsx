    ...
    <div className={`w-full fixed top-0 duration-300 z-50 ${isActive('/checkout') ? 'bg-cyan-950' : ''} ${isActive('/') ? 'bg-cyan-950/90' : ''} ${isActive('/cart') || isActive('/account') || isActive('/product') || isActive('/contact-us') || isActive('/order-details') || isActive('/store') || isActive('/my-orders') || isActive('/edit-profile') || isActive('/login') ? 'bg-white border-b' : ''} ${isActive('/about-us') ? 'bg-cyan-950' : ''} ${isActive('/') || isActive('/about-us') || isActive('/checkout') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'bg-cyan-950' : 'bg-white'}`}>
      <div className='sm:w-[90%] lg:w-[80%] h-[90px] 2lg:h-[50px] 3lg:h-[80px] lg:h-[80px] flex items-center justify-between mx-auto'>
        ...
        <ul className='hidden md:flex gap-7 lg:gap-10'>
          ...
          <Link to='/store' className={` font-overpass text-lg 2lg:text-sm 3lg:text-lg hover:text-cyan-500 duration-300 cursor-pointer ${isActive('/checkout') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'text-white' : ''} ${isActive('/cart') || isActive('/account') || isActive('/contact-us') || isActive('/store') || isActive('/my-orders') || isActive('/order-details') || isActive('/edit-profile') || isActive('/login') ? 'text-black/50' : ''}  ${isActive('/store') || isActive('/product') ? 'text-cyan-500' : ''} ${isActive('/') || isActive('/about-us') ? 'text-white' : ''}`}>Store</Link>
