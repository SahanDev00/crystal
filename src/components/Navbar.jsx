      ...
      <div className='sm:w-[90%] lg:w-[80%] h-[90px] 2lg:h-[50px] 3lg:h-[80px] lg:h-[80px] flex items-center justify-between mx-auto'>
        ...
        <div className='flex gap-3 sm:gap-4 md:gap-5 items-center justify-center'>
          <div className='flex items-center justify-center group'>
            <FaSearch className={`group-hover:text-cyan-500 size-6 2lg:size-5 3lg:size-6 cursor-pointer duration-300 ${isActive('/') ? 'text-white/90' : ''} ${isActive('/checkout') || isActive('/about-us') ? 'text-white' : ''} ${isActive('/cart') || isActive('/product') || isActive('/contact-us') || isActive('/account') || isActive('/order-details') || isActive('/my-orders') || isActive('/edit-profile') || isActive('/login') || isActive('/store') ? "text-black/50" : ''}`}  />
