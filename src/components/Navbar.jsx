    ...
    <div className={`w-full fixed top-0 duration-300 z-50 ${isActive('/checkout') ? 'bg-cyan-950' : ''} ${isActive('/') ? 'bg-cyan-950/90' : ''} ${isActive('/cart') || isActive('/account') || isActive('/product') || isActive('/contact-us') || isActive('/order-details') || isActive('/store') || isActive('/my-orders') || isActive('/edit-profile') || isActive('/login') ? 'bg-cyan-900' : ''} ${isActive('/about-us') ? 'bg-cyan-950' : ''} ${isActive('/') || isActive('/about-us') || isActive('/checkout') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'bg-cyan-950' : 'bg-white'}`}>
      <div className='sm:w-[90%] lg:w-[80%] h-[90px] 2lg:h-[50px] 3lg:h-[80px] lg:h-[80px] flex items-center justify-between mx-auto'>
        ...
        <ul className='hidden md:flex gap-7 lg:gap-10'>
          ...
          <Link to='/store' className={` font-overpass text-lg 2lg:text-sm 3lg:text-lg hover:text-cyan-500 duration-300 cursor-pointer ${isActive('/checkout') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'text-white' : ''} ${isActive('/cart') || isActive('/account') || isActive('/contact-us')  || isActive('/my-orders') || isActive('/order-details') || isActive('/edit-profile') || isActive('/login') ? 'text-white/90' : ''}  ${isActive('/store') || isActive('/product') ? 'text-cyan-500' : ''} ${isActive('/') || isActive('/about-us') ? 'text-white' : ''}`}>Store</Link>
          <Link to='/about-us' className={` font-overpass text-lg 2lg:text-sm 3lg:text-lg hover:text-cyan-500 duration-300 cursor-pointer ${isActive('/checkout') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'text-white' : ''} ${isActive('/cart') || isActive('/product') || isActive('/account') || isActive('/contact-us') || isActive('/my-orders') || isActive('/store') || isActive('/edit-profile') || isActive('/order-details') || isActive('/login') ? 'text-white' : ''} ${isActive('/about-us') ? 'text-cyan-500' : ''}  ${isActive('/') ? 'text-white' : ''}`}>About Us</Link>
          <Link to='/contact-us' className={` font-overpass text-lg 2lg:text-sm 3lg:text-lg hover:text-cyan-500 duration-300 cursor-pointer ${isActive('/checkout') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') || isActive('/about-us') ? 'text-white' : ''} ${isActive('/cart') || isActive('/product') || isActive('/account') || isActive('/store') || isActive('/my-orders') || isActive('/edit-profile') || isActive('/order-details') || isActive('/login') ? 'text-white' : ''}  ${isActive('/contact-us') ? 'text-cyan-500' : ''}  ${isActive('/') ? 'text-white' : ''}`}>Contact Us</Link>
        </ul>
        <div className='flex gap-3 sm:gap-4 md:gap-5 items-center justify-center'>
          ...
          <div className='relative group'>
            <FaUser onClick={handleProfileClick} className={`hover:text-cyan-500 size-5 2lg:size-4 3lg:size-5 cursor-pointer duration-300 mr-2 ${isActive('/checkout') || isActive('/') || isActive('/about-us') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ')  ? 'text-white' : ''} ${isActive('/cart') || isActive('/product') || isActive('/contact-us') || isActive('/store') ? "text-white" : ''} ${isActive('/account') || isActive('/order-details') || isActive('/my-orders') || isActive('/edit-profile') || isActive('/login') ? 'text-cyan-500' : ''}`} />
            {
              isLoggedIn() && (
            <div className='w-[150px] 2lg:w-[130px] 3lg:w-[150px] z-20 py-5 translate-y-4 group-hover:translate-y-0 2lg:group-hover:translate-y-2 3lg:group-hover:translate-y-0 duration-500 opacity-0 group-hover:opacity-100 bg-white absolute -left-16 border invisible group-hover:visible hidden md:block'>
                    <ul className='w-full h-full space-y-3 flex flex-col justify-center pl-5 font-karla'>
                        <Link to='/account' className='text-black/50 font-semibold cursor-pointer text-[16px] 2lg:text-[14px] 3lg:text-[16px] hover:text-black/70'>My Account</Link>
                        <Link to='/edit-profile' className='text-black/50 font-semibold cursor-pointer text-[16px] 2lg:text-[14px] 3lg:text-[16px] hover:text-black/70'>Edit Profile</Link>
                        <Link to='/my-orders' className='text-black/50 font-semibold cursor-pointer text-[16px] 2lg:text-[14px] 3lg:text-[16px] hover:text-black/70'>My Orders</Link>
                        <div onClick={handleLogout} className='text-black/50 font-semibold cursor-pointer text-[16px] 2lg:text-[14px] 3lg:text-[16px] hover:text-black/70'>Log Out</div>
                    </ul>
              </div>
              )
            }
          ...
          <div onClick={toggleMenu} className='md:hidden'>
            { !isMenu ? <IoMdMenu className={`hover:text-cyan-500 cursor-pointer duration-300 mr-2 ${isActive('/checkout') || isActive('/') || isActive('/about-us') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ')  ? 'text-white' : ''} ${isActive('/cart') || isActive('/product') || isActive('/contact-us') || isActive('/store') ? "text-white" : ''} ${isActive('/account') || isActive('/order-details') || isActive('/my-orders') || isActive('/edit-profile') || isActive('/login') ? 'text-white' : ''}  `} size={30} /> : <IoMdClose className={`hover:text-cyan-500 cursor-pointer duration-300 mr-2 ${isActive('/checkout') || isActive('/') || isActive('/about-us') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ')  ? 'text-white' : ''} ${isActive('/cart') || isActive('/product') || isActive('/contact-us') || isActive('/store') ? "text-black/50" : ''} ${isActive('/account') || isActive('/order-details') || isActive('/my-orders') || isActive('/edit-profile') || isActive('/login') ? 'text-black/50' : ''} `} size={30} /> }
          </div>
        </div>
      </div>
      ...
      { isMenu && (
          <div className='w-full h-[200px] duration-300 border-b border-black/60 shadow'>
              <ul className='flex flex-col gap-2 justify-center items-center w-full h-full'>
                ...
                <Link to='/store' className={` font-overpass text-lg hover:text-cyan-500 duration-300 cursor-pointer ${isActive('/checkout') ? 'text-white' : ''} ${isActive('/cart') || isActive('/account') || isActive('/contact-us') || isActive('/store') || isActive('/my-orders') || isActive('/order-details') || isActive('/edit-profile') || isActive('/login') ? 'text-black/50' : ''}  ${isActive('/store') || isActive('/product') ? 'text-cyan-500' : ''} ${isActive('/') || isActive('/about-us') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'text-white' : 'text-black/50'}`}>Store</Link>
                <Link to='/about-us' className={` font-overpass text-lg hover:text-cyan-500 duration-300 cursor-pointer ${isActive('/checkout') ? 'text-white' : ''} ${isActive('/cart') || isActive('/product') || isActive('/account') || isActive('/contact-us') || isActive('/my-orders') || isActive('/store') || isActive('/edit-profile') || isActive('/order-details') || isActive('/login') ? 'text-black/50' : ''} ${isActive('/about-us') ? 'text-cyan-500' : ''}  ${isActive('/') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'text-white' : 'text-black/50'}`}>About Us</Link>
                <Link to='/contact-us' className={` font-overpass text-lg hover:text-cyan-500 duration-300 cursor-pointer ${isActive('/checkout') || isActive('/about-us') ? 'text-white' : ''} ${isActive('/cart') || isActive('/product') || isActive('/account') || isActive('/store') || isActive('/my-orders') || isActive('/edit-profile') || isActive('/order-details') || isActive('/login') ? 'text-black/50' : ''}  ${isActive('/contact-us') ? 'text-cyan-500' : ''}  ${isActive('/') || isActive('/terms-of-service') || isActive('/shipping-info') || isActive('/return-policy') || isActive('/FAQ') ? 'text-white' : 'text-black/50'}`}>Contact Us</Link>
              </ul>
          </div>
        )
      }
